...
def generate_launch_description():
    ...
    urdf_file_path = '/home/ajay/ros2_ws/src/mark3/urdf/myrobo1.urdf'
    ...
    slam_params_file = '/home/ajay/ros2_ws/src/mark3/config/slam_params.yaml'
    
    # Path to RViz config file
    rviz_config_file = '/home/ajay/ros2_ws/src/mark3/rviz/master.rviz'
    
    # EKF config (commented out for now)
    # ekf_config = os.path.join(
    #     get_package_share_directory('mark3'),
    #     'config',
    #     'ekf.yaml'
    # )
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=['/home/ajay/ros2_ws/src/mark3/config/ekf.yaml']
